...
const translations = {
  da: {
    ...
    'what.p2.cont': 'og foregår i dit eget hjem med en lille, bærbar lyslampe. Teknologien bruger et pulserende lys hvor den pulserende fornemmelse er minimeret.',
    ...
    'device.title': 'EVY LIGHT® Lampen',
    'device.p1': 'Lyslampen er udviklet af',
    'device.p1.cont': 'og bruger patenteret',
    'device.p1.tech': 'invisible spectral flicker',
    'device.p1.cont2': '-teknologi til at levere gamma-neurostimulering med et pulserende lys hvor den pulserende fornemmelse er minimeret.',
    'device.p2': 'Lampen er designet til daglig brug i hjemmet og er nem at betjene. Du kan nemt bruge den',
    ...
    'device.caption1': 'EVY LIGHT® lampen fra',
